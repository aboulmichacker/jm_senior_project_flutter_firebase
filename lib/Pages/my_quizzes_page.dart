            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                        ...
                        children: [
                          const Text("Accuracy"),
                          Text("${widget.quiz.accuracy}%", style: const TextStyle(fontSize: 50),),
                    ...
                    _buildQuestion(widget.quiz.mcQuestion),
                    _buildQuestion(widget.quiz.tfQuestion),
                    _buildQuestion(widget.quiz.openEndedQuestion),
                    _buildQuestion(widget.quiz.fillInTheBlankQuestion),
                  ],
                ),
              ),
            ),
